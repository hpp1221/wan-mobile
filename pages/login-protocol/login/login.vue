	...
	<view class="login-page">
		...
		<view class="input-box">
			...
			<view class="verification-code-box">
				<input class="input-tel input-base" type="number" :value="codeNum" placeholder="请输入验证码" placeholder-class="pla-class" @input="codeInput" />
		...
		<label class="is-agree-box">
			<checkbox value="cb" style="transform:scale(0.6) translate3d(8px, -9px, 0)"/>
			<view class="tip-text">
